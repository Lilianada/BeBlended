    ...
    <main className="mainWrapper adminClient_Profile">
        ...
        <div className="adminClient_subhead">
          <div className="subHead">
            <h4 className="formHead">
              My Clients <AiOutlineMinus style={{margin: "0 .75rem"}} /> Melly Thomas
            </h4>
          </div>
        </div>
        <hr/>
      ...
      <div className="clientProfile_Grid">
        <div className="clientDetails">
            <img src={BeblendedHead} alt="Client Profile Image" className="clientImg"/>
        ...
        <div className="clientAppointments"></div>
      </div>
    </main>
  );
}
