      ...
      <Slider 
          ...
          <div className="row">
            ...
            <p>
              ...
              appointment actually went being confrontational.
            </p>
          </div>
          <div className="row">
            <div className="iconWrap">
            ...
            <h6>Security</h6>
            <p>
              Whether it’s reporting an incident or making sure you get paid -
              we provide resources to hold everyone accountable
            </p>
          </div>
          <div className="row">
            <div className="iconWrap">
      ...
      <div className="desktopRow">
        <div className="supportRow">
          <div className="row">
            ...
            <h6>Client Reviews</h6>
            <p>
              We create a space for you to tell the truth about how your client
              behaved <strong>without</strong> being confrontational.
            </p>
          </div>
          <div className="row">
            <div className="iconWrap">
